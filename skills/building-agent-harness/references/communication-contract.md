...
Lead with the decision, not an inventory. Explain jargon on first use and keep evidence close to the claim it supports.

Each proposed package must let the human understand:

- What problem it solves.
- Why it matters now.
- Which repository surfaces it changes.
- What it deliberately leaves unchanged.
- Its risk and rollback path.
- Whether it needs separate approval.
